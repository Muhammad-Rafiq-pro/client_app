...
class MessageBubble extends StatelessWidget {
  MessageBubble({required this.text, required this.time, required this.isSent, required this.disease});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        ChatBubble(
          clipper: ChatBubbleClipper1(type: isSent ? BubbleType.sendBubble : BubbleType.receiverBubble),
