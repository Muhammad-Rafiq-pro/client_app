...
import 'package:psych_diagnosis/accounts/screen_pshch_forgot_password.dart';
import 'package:psych_diagnosis/accounts/screen_psych_sign_up.dart';
  ...
  Future<void> handleSignIn(BuildContext context) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => PsychHome()),
      );
    } catch (e) {
